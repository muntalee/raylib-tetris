  ...
  public:
    JBlock() {
        ...
        cells[1] = {Position(0, 0), Position(0, 1), Position(1, 0),
                    Position(2, 0)};
        cells[2] = {Position(0, 0), Position(0, 1), Position(0, 2),
                    Position(1, 2)};
...
class OBlock : public Block {
  public:
    OBlock() {
        ...
        cells[1] = {Position(0, 0), Position(0, 1), Position(1, 0),
                    Position(1, 1)};
        cells[2] = {Position(0, 0), Position(0, 1), Position(1, 0),
                    Position(1, 1)};
  ...
  public:
    SBlock() {
        ...
        cells[0] = {Position(0, 1), Position(0, 2), Position(1, 0),
                    Position(1, 1)};
        cells[1] = {Position(0, 0), Position(1, 0), Position(1, 1),
                    Position(2, 1)};
        cells[2] = {Position(0, 1), Position(0, 2), Position(1, 0),
                    Position(1, 1)};
  ...
  public:
    ZBlock() {
        ...
        cells[0] = {Position(0, 0), Position(0, 1), Position(1, 1),
                    Position(1, 2)};
        cells[1] = {Position(0, 1), Position(1, 0), Position(1, 1),
                    Position(2, 0)};
